...
AUTHOR: Andy Mallon
CREATED: 20260601
    Config-driven driver around unmodified Ola Hallengren IndexOptimize. This proc makes
    the per-table decisions IndexOptimize cannot make on its own, then hands the actual work
    to Ola so we never fork his code:
...
-- EXEC dbo.Update_Statistics @DbName = N'MyDb', @SkewAnalysis = 1, @SkewRatioCutoff = 100.00;
